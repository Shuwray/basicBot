...
(function () {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            skipPosition: 1,
            skipReasons: [
                ["tema, "O tema não está de acordo com as regras. "],
                ["op", "Está música está na lista de OP "],
                ["histórico", "Está música está no histórico. "],
                ["mix", "Sua música é um "mix", e está contra as regras. "],
                ["música", "Sua música contém má quanlidade no som, ou não está tocando."],
                ["nsfw", "Sua música contém NSFW. "],
                ["indísponivel", "Música indísponivel para alguns usuários "]
            ],
            afkpositionCheck: 15,
            afkRankCheck: "ambassador",
            motdEnabled: false,
            motdInterval: 5,
            motd: "Seja bem vindo(a) a sala "Alternative Rock", divirta-se.",
            filterChat: true,
